...
//     await page
//       .getByRole("heading", { name: "Display Your NFT Gallery In A Stunning Grid View" })
//       .scrollIntoViewIfNeeded();
//     await expect(page.getByRole("heading", { name: "Display Your NFT Gallery In A Stunning Grid View" })).toBeVisible();
//     await expect(
//       page.getByText(
//         "Grab the attention of your website visitors in an engaging way by showcasing your NFT gallery with a modern and stylish grid view layout."
//       )
//     ).toBeVisible();
//   });
// });
