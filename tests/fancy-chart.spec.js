...
//     await page
//       .getByRole("heading", { name: "Visualize Data With Different Type Of Dynamic Graphs Using EA Fancy Chart" })
//       .scrollIntoViewIfNeeded();
//     await expect(
//       page.getByRole("heading", { name: "Visualize Data With Different Type Of Dynamic Graphs Using EA Fancy Chart" })
//     ).toBeVisible();
