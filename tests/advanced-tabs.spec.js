...
test.describe("Advanced Tabs - Use Horizontal Layout of Tabs", () => {
  ...
  test("All sections should be present", async () => {
    ...
    await expect(advtab_nav_1).toBeVisible();
    await expect(advtab_nav_2).toBeVisible();
    await expect(advtab_nav_3).toBeVisible();
    await expect(advtab_nav_4).toBeVisible();

    // Icons Should be visible
    await expect(advtab_nav.getByRole("tab", { name: "PHILOSOPHY" }).locator("path")).toHaveAttribute(
      "d",
    ...
    await expect(advtab_nav.getByRole("tab", { name: "MISSION & VISION" }).locator("path")).toHaveAttribute(
      "d",
    ...
    await expect(advtab_nav.getByRole("tab", { name: "GOALS" }).locator("path").first()).toHaveAttribute(
      "d",
    ...
    await expect(advtab_nav.getByRole("tab", { name: "PRIVACY POLICY" }).locator("path").first()).toHaveAttribute(
      "d",
    ...
    await expect(advtab_content_1).toBeVisible();
  });
  ...
  test("The first tab should be expanded by default", async () => {
    ...
    await expect(advtab_content_1).toBeVisible();
    await expect(advtab_content_2).toBeHidden();
    await expect(advtab_content_3).toBeHidden();
    await expect(advtab_content_4).toBeHidden();
  });
  ...
  test("Tab expand/shrink should work", async ({ page }) => {
    ...
    await expect(advtab_content_1).toBeHidden();
    await expect(advtab_content_2).toBeVisible();
    await expect(advtab_content_3).toBeHidden();
    await expect(advtab_content_4).toBeHidden();
    ...
    await expect(advtab_content_1).toBeHidden();
    await expect(advtab_content_2).toBeHidden();
    await expect(advtab_content_3).toBeVisible();
    await expect(advtab_content_4).toBeHidden();
