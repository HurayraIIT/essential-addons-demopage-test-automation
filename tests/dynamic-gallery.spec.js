...
//       "href",
//       /docs\/dynamic-content-elements\/dynamic-filterable-gallery/
//     );
//   });

//   test("Test Section: Attractive Grid Layout To Showcase All Of Your Posts", async ({ page }) => {
//     await page
//       .getByRole("heading", { name: "Attractive Grid Layout To Showcase All Of Your Posts" })
//       .scrollIntoViewIfNeeded();
//     await expect(
//       page.getByRole("heading", { name: "Attractive Grid Layout To Showcase All Of Your Posts" })
//     ).toBeVisible();
//     await expect(page.getByText("Choose the Grid Layout option to showcase your blog")).toBeVisible();

//     await expect(
//       page.locator("#eael-filter-gallery-wrapper-3990f5c div").filter({ hasText: "AllElementorWordPressTemplates" })
//     ).toBeVisible();
//     await expect(page.locator("#eael-filter-gallery-wrapper-3990f5c").getByText("All", { exact: true })).toBeVisible();
//     await expect(
//       page.locator("#eael-filter-gallery-wrapper-3990f5c").getByText("Elementor", { exact: true })
//     ).toBeVisible();
//     await expect(
//       page.locator("#eael-filter-gallery-wrapper-3990f5c").getByText("WordPress", { exact: true })
//     ).toBeVisible();
